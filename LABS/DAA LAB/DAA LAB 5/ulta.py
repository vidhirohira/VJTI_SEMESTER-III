...
# Example of how to use both compression and decompression:
def decompress_example():
    # Use a previously compressed file (you should have compressed output and huffman codes)
    compressed_text, huffman_codes = process_file('docx', 'book.docx')  # Adjust this to your file

    # Now decompress using the same codes
    decompressed_text = decompress(compressed_text, huffman_codes)
    
    print(f"Decompressed text: {decompressed_text[:500]}...")  # Print first 500 chars of decompressed text for preview
